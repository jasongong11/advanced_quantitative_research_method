...
3. We set up a significance level $\alpha$, in a way such that if this probability $ < \alpha$, we reject $H_0$, other wise, we accept $H_0$. 
...
This is larger than $\alpha$, thus we reject the null hypothesis
